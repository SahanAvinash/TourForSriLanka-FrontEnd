...
export default function TransportHeroSection({ form, updateForm, onSearch }) {
  return (
    <section className="relative pt-24 sm:pt-28 bg-[#11212D] overflow-hidden">
      <div className="relative min-h-[720px] sm:min-h-[620px] lg:h-[430px] lg:min-h-0">

        <div className="absolute inset-x-2 sm:inset-x-4 top-0 bottom-[-100px] rounded-[20px] sm:rounded-[30px] overflow-hidden">
          <img
            src={heroBg}
            alt="Transport"
          ...
          <div className="absolute inset-x-0 bottom-0 h-[430px] sm:h-[360px] lg:h-[250px] bg-gradient-to-b from-transparent via-[#11212D]/70 to-[#11212D]" />

          <div className="absolute inset-x-0 bottom-0 h-[170px] sm:h-[140px] lg:h-[110px] bg-gradient-to-b from-transparent to-[#11212D]" />
        </div>
