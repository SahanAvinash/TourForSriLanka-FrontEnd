...
export default function TransportHeroSection({
  ...
  return (
    <section className="relative pt-24 sm:pt-28 bg-[#11212D]">
      {/* Hotels page eka wage height eka wadi karala, rounded container eka mx-2 / mx-4 walin thibba widihata hdhdawa */}
      <div className="relative min-h-[640px] sm:min-h-[600px] lg:h-[560px] lg:min-h-0 mx-2 sm:mx-4">
        ...
        {/* Search bar eka image eka eliyata yanne nethuwa, athulma bottom eke thiyenna oya widihata position kala */}
        <div className="absolute bottom-6 sm:bottom-8 left-3 right-3 sm:left-8 sm:right-8 lg:left-12 lg:right-12 z-20">
          <div className="bg-[#455766]/40 sm:bg-[#455766]/45 lg:bg-[#455766]/55 backdrop-blur-xl rounded-[20px] sm:rounded-[28px] border border-white/10 shadow-2xl p-4 sm:p-6 lg:p-0 lg:h-[100px] flex flex-cl lg:flex-row lg:items-center lg:px-8">
      ...
      {/* Ara loku spacer div eka complete ain kala, eka nisa hotels page eke wage eka liganta clean widihata thiyenawa */}
    </section>
  );
}