        ...
        <div className="absolute inset-0 flex items-center">
          <div className="max-w-7xl mx-auto w-full px-8">
            <div className="max-w-lg">
              ...
              <Link
                to="/tours"
                className="hero-btn-anim inline-block mt-8 bg-[var(--color-primary-green)] hover:bg-[#00b383] transition-all duration-300 px-8 py-3 rounded-full font-semibold text-white shadow-lg"
              >
                Plan Your Trip
              </Link>
            </div>
