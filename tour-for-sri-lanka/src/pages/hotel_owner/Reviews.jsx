...
export default function Reviews() {
    ...
    function fetchReviews() {
        ...
        axios
            .get(
                `${API_BASE_URL}/api/review/hotel/${hotelId}`
            )
            .then((res) => {
                setReviews(
        ...
        return [1, 2, 3, 4, 5].map(
            (number) =>
                ...
                Math.round(numericRating) ? (
                    <FaStar
                        key={number}
                        className="text-[#E8A33D] text-[13px]"
                    />
                ) : (
                    <FaRegStar
                        key={number}
                        className="text-[#4A5C6A] text-[13px]"
                    />
                )
        );
    }
    ...
    return (
        <section
            id="reviews"
            className="w-full mt-10 sm:mt-12 px-4 sm:px-6 md:px-8 lg:px-10 overflow-x-hidden"
        >
                ...
                {!loadingReviews &&
                    totalReviews > 0 && (
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-6 items-stretch">
                            <div className="bg-[#253745] rounded-[24px] p-6 sm:p-8 flex flex-col justify-center">
                                <p className="text-[#CCD0CF]/60 text-[14px] sm:text-[15px] mb-3">
                                    Average Rating
                                </p>

                                <p className="text-[#CCD0CF] text-[52px] sm:text-[64px] font-bold leading-none">
                                    {
                                        averageRating
                                    }
                                </p>
                            ...
                            <div className="bg-[#253745] rounded-[24px] p-6 sm:p-8 flex flex-col justify-center">
                                ...
                                <p className="text-[#CCD0CF]/50 text-[12px] sm:text-[13px] mt-4">
                                    {
                                        ratingCounts[0]
                                            .count
                                    }{" "}
                            ...
                            <div className="bg-[#253745] rounded-[24px] p-6 sm:p-8">
                                <p className="text-[#CCD0CF]/60 text-[14px] sm:text-[15px] mb-4">
                                    Rating Breakdown
                                </p>
                                ...
                                <div className="space-y-2.5">
                                    {ratingCounts.map(
                                        ({
                                            ...
                                            >
                                                <span className="text-[#CCD0CF]/60 w-[10px]">
                                                    {
                                                        star
                                                    }
                                                </span>
                                                ...
                                                <span className="text-[#CCD0CF]/60 w-[18px] text-right">
                                                    {
                                                        count
                                                    }
                                                </span>
                                        ...
                                        >
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <p className="text-[#CCD0CF]/80 text-[13px] leading-relaxed break-words">
                                                        {
                                                            review.comment
                                                        }
                                                    </p>
                            ...
                            {filteredReviews.length >
                                ...
                                <div className="flex justify-center mt-6">
                                    <button
                                        ...
                                        className="h-[42px] px-6 rounded-[20px] bg-[#4A5C6A]/50 text-[#00C896] text-[13px] font-bold hover:bg-[#4A5C6A]/70 cursor-pointer transition-colors"
                                    >
                                        {showAll
                                            ? "Show Less"
