...
const TourPage = () => {
  ...
  <input
    ...
    className="w-full bg-[#253745] border border-[#3a4b58] rounded-md px-3 py-2 text-white focus:outline-none focus:border-[#00C896] [-webkit-appearance:auto] [color-scheme:dark]"
  />
</div>
