...
export default function GuideReviews({ guideId, reviews, onReviewAdded, onReviewDeleted }) {
  ...
  function handleImageUpload(e) {
    ...
    const uploadPromise = files.map((file) => {
      ...
      return axios.post(`${API_BASE}/guide/upload-photo`, formData, {
  ...
  async function handleDeleteReview(){
    ...
    try{
        const res = await fetch(`${API_BASE}/guidereview/${guideId}/${currentUserEmail}`,{
            method: "DELETE",
  ...
  async function submitReview() {
    ...
    try {
      ...
      const url = isUpdate ? `${API_BASE}/guidereview/${myReview._id}` : `${API_BASE}/guidereview`;
