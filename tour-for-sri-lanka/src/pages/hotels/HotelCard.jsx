...
const HotelCard = ({ hotel }) => {
  ...
  return (
    <div
      ref={cardRef}
      className={`destination-card-anim ${inView ? "in-view" : ""} bg-[#253745] rounded-[20px] overflow-hidden hover:scale-[1.02] transition-all duration-300 cursor-pointer group`}
    >
