...
export default function VerifyOtpTransport(){
    ...
    const { drivingLicense, vehicleRegistrationCertificate, insuranceCertificate, revenueLicense, profilePhoto } = location.state || {}
    ...
    const handleResend = async () => {
        ...
        setErr("")
        try{
            const response = await fetch("http://localhost:3000/api/transport/send-otp", {
                method: "POST",
