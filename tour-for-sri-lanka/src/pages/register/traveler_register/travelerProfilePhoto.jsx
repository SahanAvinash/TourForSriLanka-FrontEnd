            ...
            >
              {photo ? (
                ...
                <>
                  ...
                  <p className="text-[10px] text-text/50 mt-[5px] text-center pl-[5px] pr-[5px]">
                    Drag & Drop your photo
                  </p>
                  <p className="text-[10px] text-text/50 text-center">or</p>
                  <p className="text-primary-green/50 text-[10px] group-hover:text-primary-green/80 transition-all duration-300">
                    Browse Files
                  </p>
                </>
              )}
